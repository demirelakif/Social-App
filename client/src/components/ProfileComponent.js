...
const ProfileComponent = ({ match, location }) => {
    ...
    useEffect(() => {
        postService.getPostsFromUser(username).then((response) => {
            setPosts(response)
        })
        ...
        <div className='mt-10'>
            ...
            <div class="bg-slate-700 w-full py-10 px-10">
                ...
                <div class="sm:grid lg:grid-cols-4 grid-cols-2 sm:gap-x-4">
                    {posts ?
                        posts.map(post => (
                            <div key={post._id} class=" flex justify-between items-center bg-slate-600 p-6 rounded-md mb-4">
                                ...
                                <div class="px-3 pb-2">
                                    <div class="pt-2">
                                        ...
                                        <span class="text-sm text-gray-400 font-medium">{post.likes.length} Like</span>
                                    </div>
